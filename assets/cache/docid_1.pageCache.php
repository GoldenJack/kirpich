...
<html lang="ru">
	<head>
		...
		<base href="http://localhost/kirpich/kirpich/"/>

		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta http-equiv="X-UA-Compatible" content="IE=edge">

		<link href="http://localhost/kirpich/kirpich/" rel="canonical">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12" itemscope itemtype="http://schema.org/Organization">
						...
						<a class="logo" href="[~1~]" title="Кирпич" itemprop="url">
							<img src="http://localhost/kirpich/kirpich/manager/media/style/default/images/misc/login-logo.png" itemprop="logo" alt="Кирпич" />
						</a>
						...
						<nav class="navbar" role="navigation" data-spy="affix" data-offset-top="100">
							...
							<div id="navbar" class="navbar-collapse collapse">
								...
								<ul class="nav navbar-nav"><li class="first level1 active odd"><a href="/kirpich/kirpich/">Home</a></li><li class="level1 even"><a href="/kirpich/kirpich/blog.html">Blog</a></li><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Features">Features <b class="caret"></b></a><ul class="dropdown-menu"><li class="first level2 odd"><a href="/kirpich/kirpich/features/ajax.html">Ajax</a></li><li class="level2 even"><a href="/kirpich/kirpich/features/menus.html">Menus and Lists</a></li><li class="level2 odd"><a href="/kirpich/kirpich/features/cms.html">Manage Content</a></li><li class="last level2 even"><a href="/kirpich/kirpich/features/extendable.html">Extendability</a></li></ul></li><li class="level1 even"><a href="/kirpich/kirpich/getting-help.html">Getting Help</a></li><li class="level1 odd"><a href="/kirpich/kirpich/design.html">Design</a></li><li class="level1 even"><a href="/kirpich/kirpich/contact-us.html">Contact us</a></li><li class="last level1 odd"><a href="/kirpich/kirpich/profile.html">Profile</a></li></ul>
...
<p><strong>To log into the EVO Control Panel and start customizing this site, point your browser to <a href="manager">/manager/</a>.</strong></p>
					...
					<aside class="col-sm-4">
						<div class="search">
							<h2>Search</h2>
							<p class="bg-danger">For work AjaxSearch in demo site you need install <b>AjaxSearch</b> from <a href="http://localhost/kirpich/kirpich/manager/#?a=112&id=2">Extras</a> module</p>
							[!AjaxSearch? 
							&ajaxSearch=`1` 
							&addJscript=`0` 
							&showIntro=`0` 
						...
						<h2>News:</h2>
						<strong><a href="/kirpich/kirpich/blog/new-documentation-site-docs.evo.im.html" title="New documentation site: docs.evo.im">New documentation site: docs.evo.im</a></strong><br />
						Multilingual documentation for Evolution CMS <br /><br /><strong><a href="/kirpich/kirpich/blog/article-1126081344.html" title="Mini-Blog HOWTO">Mini-Blog HOWTO</a></strong><br />
						How to Start Posting with EVO Mini-Blogs<br /><br /><strong><a href="/kirpich/kirpich/blog/article-1128398162.html" title="Just a pretend, older post">Just a pretend, older post</a></strong><br />
						...
						<div>
							...
							<ul>
								<li><a href="/kirpich/kirpich/sitemap.xml" title="sitemap.xml">sitemap.xml</a> <span class="date">11.Oct.17 13:03</span></li><li><a href="/kirpich/kirpich/" title="Home">Home</a> <span class="date">13.Apr.06 05:00</span></li><li><a href="/kirpich/kirpich/blog.html" title="Blog">Blog</a> <span class="date">13.Apr.06 05:00</span></li><li><a href="/kirpich/kirpich/profile.html" title="Profile">Profile</a> <span class="date">13.Apr.06 05:00</span></li><li><a href="/kirpich/kirpich/contact-us.html" title="Contact Us">Contact Us</a> <span class="date">13.Apr.06 05:00</span></li>
							</ul>
