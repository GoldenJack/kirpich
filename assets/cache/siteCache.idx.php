...
';$c['header']='<header class="header" id="header">
	<div class="container">
...
</div>';$c['products']='<section class="products" id="products">
...
</section>';$c['partner']='<div class="partner col-md-4 col-lg-3 col-sm-6 col">
	<img src="[+partnerImg+]" alt="[+pagetitle+]">
</div>';$c['header_slider_elem']='<div class="header__slider__elem">
	<img src="[+headerSliderImg+]" alt="" class="header__slider__image">
	<span class="header__slider__text">[+content+]</span>
</div>';$c['sertifics']='<section class="sertifics" id="sertifics">
	<div class="container">
		<div class="row">
			<div class="col-12">
...
</section>';$c['calc']='<section class="calc" id="calc">
...
</section>';$c['partners']='<section class="partners" id="partners">
...
</section>';$c['work']='<section class="work" id="work">
	<div class="container wrap">
		<div class="row">
			<div class="col-12">
...
</section>';$c['guarant']='<section class="guarant" id="guarant">
...
</section>';$c['sert_slider_elem']='
<div class="sertific__item">
	<img src="[+sertSliderImg+]" class="sertific__image">
</div>';$c['offers']='<section class="offers" id="offers">
	<div class="container wrap">
		<div class="row">
			<div class="col-12">
...
</section>';$c['successTpl']='Письмо с сайта
Имя: [+name.value+]
Телефон: [+phone.value+]';$c['product_plit']='<div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col">
...
</div>';$c['ask']='<section class="ask" id="ask">
...
</section>';$c['footer']='<footer class="footer" id="footer">
	<div class="container">
		<div class="row justify-content-center">
...
</footer>';$c['form_callme_tpl']='<div class="callback modal" id="callback">
...
</div>';$c['offer_slider_elem']='<div class="col-xl-4 col-lg-4 col-sm-10 col-md-6 offer__elem">
	<div class="offer">
...
return $data;';$p=&$this->pluginCache;$p['FileSource']='require MODX_BASE_PATH.\'assets/plugins/filesource/plugin.filesource.php\';';$p['ManagerManager']='/**
 * ManagerManager
 *
